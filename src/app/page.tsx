    ...
    return (
        <main className="min-h-screen bg-gray-50 flex flex-col font-sans text-gray-900">
            ...
            <header className="bg-white shadow-sm p-6 text-center">
                <h1 className="text-4xl font-extrabold text-blue-700 tracking-tight">OpenClaw Setup</h1>
                <p className="mt-2 text-xl text-gray-600">Simple, secure installation for your computer.</p>
            </header>

            {/* Main Content */}
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center max-w-4xl mx-auto space-y-12">
                ...
                <div className="bg-white p-10 rounded-3xl shadow-xl border-2 border-blue-100 w-full max-w-lg transition-transform hover:scale-105">
                    {os === 'Unknown' ? (
                        <p className="text-lg text-gray-500 animate-pulse">Detecting your computer type...</p>
                    ) : (
                        <div className="space-y-6">
                            <div className="flex justify-center text-6xl mb-4">
                                {os === 'Windows' ? '🪟' : os === 'Mac' ? '🍎' : '🐧'}
                            </div>
                            <h3 className="text-2xl font-bold text-gray-800">We detected you are on {os}</h3>
